...
const createCountry = async (req: Request, res: Response) => {
  ...
  let countryExist: countryDBType = await Countries.getCountryByUserID(
    req.body.userID
  );
...
const build = async (req: Request, res: Response) => {
  ...
  response.payload = Countries.build(
    parseInt(req.body.farm),
    parseInt(req.body.business),
    parseInt(req.body.research),
    user.countryID
  );
...
const research = async (req: Request, res: Response) => {
  console.log("\nRESEARCH\n");
  console.log("req.body: ", req.body);
  ...
  response.payload = Countries.research(
    parseInt(req.body.farm),
    parseInt(req.body.business),
    user.countryID
  );
...
const explore = async (req: Request, res: Response) => {
  ...
  response.payload = Countries.explore(
